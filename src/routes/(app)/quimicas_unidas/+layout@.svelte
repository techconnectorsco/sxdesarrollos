	...
	<header class="sticky top-0 z-50 border-b border-border bg-card/80 backdrop-blur-sm">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-2">
			<div class="flex items-center gap-3">
				...
				<span class="text-sm font-semibold text-foreground">Portal CXC</span>
			</div>
			<div class="flex items-center gap-2">
				...
				<Button onclick={toggleMode} variant="outline" size="icon" class="relative overflow-hidden">
					<SunIcon class="h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all dark:scale-0 dark:-rotate-90" />
					<MoonIcon class="absolute h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all dark:scale-100 dark:rotate-0" />
