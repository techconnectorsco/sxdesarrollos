	...
	const pasos = [
		{
			n: '01',
			t: 'Diagnóstico',
			d: 'Analizamos tus procesos e identificamos los de mayor impacto para automatizar primero.'
		},
		{
			n: '02',
			t: 'Diseño',
			d: 'Creamos el flujo y definimos las reglas de negocio con tu equipo.'
		},
		{
			n: '03',
			t: 'Implementación',
			d: 'Desarrollamos, probamos y desplegamos el robot integrado a tus sistemas.'
		},
		{
			n: '04',
			t: 'Monitoreo 24/7',
			d: 'Supervisamos con alertas en tiempo real y optimizamos continuamente.'
		}
	];
...
<div class="flex min-h-screen flex-col">
	...
	<main class="flex-1 pt-[72px]">
		<!-- ================================================
		     ...
		     ================================================ -->
		<section
			class="relative min-h-[88vh] flex items-center px-4 sm:px-6 py-16 sm:py-20 overflow-hidden"
		>
			<div class="hero-grid absolute inset-0 pointer-events-none"></div>

			<!-- Blobs decorativos -->
			<div
				class="blob-blue absolute -top-40 -left-40 w-[500px] h-[500px] rounded-full blur-[130px] pointer-events-none"
			></div>
			<div
				class="blob-slate absolute bottom-0 right-0 w-[360px] h-[360px] rounded-full blur-[100px] pointer-events-none"
			></div>
			...
			>
				...
				>
					...
					<span class="text-xs font-bold uppercase tracking-wide text-blue-600 dark:text-blue-400"
						>SoporteXperto</span
					>
					<svg
						class="w-3 h-3 text-blue-500 opacity-80 shrink-0"
						viewBox="0 0 12 12"
						fill="none"
						stroke="currentColor"
						stroke-width="1.8"
				...
				<h1
					class="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.07] tracking-tight mb-4 sm:mb-5 text-foreground"
				>
					Automatización<br />
				...
				<div class="mb-7 sm:mb-9 pl-4 border-l-2 border-blue-500">
					<p class="text-sm sm:text-base leading-relaxed text-muted-foreground">
						...
						de SoporteXperto — el equipo especializado en automatizar procesos empresariales para que
						tu organización opere más rápido, con menos errores y mayor rentabilidad.
					</p>
				</div>
          ...
          transition-colors duration-200"
				...
				<div
					class="grid grid-cols-2 sm:grid-cols-4 rounded-xl overflow-hidden border border-border bg-card shadow-sm w-full sm:w-auto sm:inline-grid"
				>
					{#each [{ v: '24+', l: 'Procesos activos' }, { v: '15+', l: 'Clientes en CR' }, { v: '12k+', l: 'Horas ahorradas' }, { v: '99.8%', l: 'Tasa de éxito' }] as s, i}
						<div
							class="flex flex-col px-4 sm:px-5 py-3 sm:py-3.5 gap-1
							{i % 2 === 0 ? 'border-r border-border' : ''}
							{i < 2 ? 'border-b sm:border-b-0 border-border' : ''}
							sm:not-last:border-r"
						>
							<span
								class="text-lg sm:text-xl font-extrabold leading-none text-blue-600 dark:text-blue-400"
								>{s.v}</span
							>
							<span
								class="text-[9px] sm:text-[10px] uppercase tracking-widest font-semibold text-muted-foreground"
								>{s.l}</span
							>
						</div>
					{/each}
     ...
     ================================================ -->
			<div
				class="absolute right-[4%] top-1/2 -translate-y-1/2 hidden xl:block z-10"
				style="width:420px"
			>
	     ...
	     "
				...
				<div
					class="absolute -top-5 -left-12 z-20 px-4 py-3 rounded-2xl shadow-xl
	     ...
	     "
				>
					<p
						class="text-[9px] font-semibold uppercase tracking-widest mb-2"
					...
					<div class="flex items-end gap-3">
						<div>
							...
							<p class="text-[9px] mt-0.5 font-medium" style="color:rgba(148,163,184,.7)">
								docs procesados
							</p>
						</div>
						<div class="pb-0.5">
				...
				<div
					class="absolute -bottom-5 -right-8 z-20 flex items-center gap-2.5 px-4 py-2.5 rounded-2xl shadow-xl
	     ...
	     "
				>
					...
					<div>
						<p class="text-[11px] font-semibold leading-tight" style="color:#f1f5f9">
				...
				<!-- Terminal principal -->
				<div
					class="rounded-2xl overflow-hidden font-mono text-xs shadow-2xl ring-1"
					style="
	       background: #0d1117;
				...
				>
					...
					>
						<div class="flex items-center gap-1.5">
							<span
								class="w-3 h-3 rounded-full transition-opacity duration-150 hover:opacity-80 cursor-default"
						...
						<div
							class="flex items-center gap-1.5 px-3 py-1 rounded-md"
						...
						>
							<svg
								...
								stroke-width="2"
							>
								<path d="M13 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V9z" /><polyline
						...
						<div class="flex gap-1">
							{#each [1, 2, 3] as _}
								<span
									class="w-5 h-5 rounded flex items-center justify-center cursor-default hover:bg-white/5 transition-colors"
								>
					...
					<div class="flex border-b" style="background:#161b22; border-color:rgba(255,255,255,.04)">
						<div
							class="flex items-center gap-1.5 px-4 py-2 border-r border-b-2"
						...
						<div
							class="flex items-center gap-1.5 px-4 py-2 border-r border-b-2 border-b-transparent"
					...
					<div
						class="flex items-center justify-between px-4 py-0 text-[10px]"
					...
					>
						...
						<div class="flex items-center gap-1.5" style="color:rgba(255,255,255,.75)">
							<span class="w-1.5 h-1.5 rounded-full animate-pulse" style="background:#4ade80"
							></span>
		...
		<div class="border-y border-border bg-muted px-6 py-5 text-center">
			...
			<div class="flex flex-wrap justify-center gap-2">
				{#each [{ name: 'Microsoft 365', logo: '/microsoft.png' }, { name: 'Dynamics 365', logo: '/dynamics.png' }, { name: 'Power Automate', logo: '/PA.png' }, { name: 'Azure', logo: '/azure.png' }, { name: 'SAP', logo: '/SAP.png' }, { name: 'Google Workspace', logo: '/google.png' }] as tool}
					<span
						class="inline-flex items-center gap-2.5 px-5 py-2 rounded-full text-xs font-medium border border-border bg-card text-foreground"
					>
		...
		<section class="py-24 px-6">
			<div class="max-w-6xl mx-auto">
				<div class="text-center mb-14">
					<p
						class="text-xs font-bold uppercase tracking-[0.14em] mb-3 text-blue-600 dark:text-blue-400"
					>
						Lo que ofrecemos
					</p>
					...
					<p class="max-w-lg mx-auto leading-relaxed text-sm text-muted-foreground">
						Desde robots RPA hasta pipelines en la nube, cubrimos todo el espectro de la
						automatización empresarial.
					</p>
				</div>

				<div
					class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px rounded-2xl overflow-hidden shadow-sm
				...
				>
					{#each servicios as s, i}
						...
						>
							<div
								class="w-11 h-11 flex items-center justify-center rounded-lg mb-5 transition-all duration-200
							...
							<span
								class="absolute bottom-5 right-5 font-semibold text-blue-500
					...
					{#each pasos as step, i}
						<div class="flex items-start">
							<div class="text-center w-44 px-3">
								<div
									class="inline-flex items-center justify-center w-11 h-11 rounded-full mb-4
...
{/if}
		...
		<!-- ================================================
		     ...
		     ================================================ -->
		<section
			class="relative py-28 px-6 overflow-hidden text-center"
		...
		>
			...
			<div
				class="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[260px] rounded-full blur-[120px] pointer-events-none"
				style="background: rgba(59,130,246,0.15)"
			></div>

			<div class="relative z-10 max-w-2xl mx-auto">
				<p
					class="inline-block px-4 py-1.5 rounded-full mb-6 text-xs font-bold uppercase tracking-widest
				...
				<h2
					class="font-serif text-4xl md:text-5xl font-bold leading-tight tracking-tight mb-5 text-white"
				>
					¿Cuántas horas pierde<br />tu equipo hoy?
				</h2>

				<p
					class="text-base leading-relaxed mb-10 max-w-md mx-auto"
					style="color: rgba(191,219,254,0.8)"
				>
					Cada día sin automatización es tiempo y dinero que no recuperas. Conversemos — diseñamos
					tu solución en 72 horas.
				</p>
